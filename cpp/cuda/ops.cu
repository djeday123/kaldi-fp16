...
extern "C"
{
                 ...
                 void *C, int ldc)
    {
        ...
        // i.e. cublas sees: op(B) * op(A) with transposed dimensions
    ...
    // Input layout:  [h0*f1_0, h1*f1_0, ..., h39*f1_0, h0*f2_0, h0*f2_1, ...]
    // Output layout: [h0*f1_0, h0*f2_0, h0*f2_1, ..., h1*f1_0, h1*f2_0, ...]
    // ============================================================
